...
document.getElementById("preresult").innerHTML="You got " + (4-count).toFixed(0) + " answers correct out of 4";
}
function postquiz()
{
...
document.getElementById("preresult").innerHTML="You got " + (3-count).toFixed(0) + " answers correct out of 3";
}